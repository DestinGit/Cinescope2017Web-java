...
<nav class="navbar navbar-inverse">
    <ul class="nav nav-pills" id="menu">
        ...
        <li><a href="#">Hit parade</a></li>
        <li><a href="#">Avis des critiques</a></li>
        <li><a href="#">Salles de Paris</a></li>
        <li><a href="#">Salle de la périphérie</a></li>
        <li><a href="#">Recherche avancée</a></li>
        <li><a href="#">Les articles</a></li>
        <li><a href="#">Avant-premières</a></li>
